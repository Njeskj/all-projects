...
const (
	MatchingEngine_SubmitOffer_FullMethodName = "/matching.MatchingEngine/SubmitOffer"
)
...
func (c *matchingEngineClient) SubmitOffer(ctx context.Context, in *SubmitOfferRequest, opts ...grpc.CallOption) (*SubmitOfferResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SubmitOfferResponse)
	err := c.cc.Invoke(ctx, MatchingEngine_SubmitOffer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMatchingEngineServer) SubmitOffer(context.Context, *SubmitOfferRequest) (*SubmitOfferResponse, error) {
...
func _MatchingEngine_SubmitOffer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmitOfferRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MatchingEngineServer).SubmitOffer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MatchingEngine_SubmitOffer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MatchingEngineServer).SubmitOffer(ctx, req.(*SubmitOfferRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _MatchingEngine_SubmitOffer_Handler,
		},
	},
